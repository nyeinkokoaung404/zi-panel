...
systemctl stop zivpn-cleanup.service 2>/dev/null || true # Stop new service if it existed
...
# ===== Web Admin & ENV Setup (Updated for new features) =====
...
BOT_TOKEN="${BOT_TOKEN:-8079105459:AAFNww6keJvnGJi4DpAHZGESBcL9ytFxqA4}" # Use a placeholder if empty
...
# ===== Ask initial VPN passwords (No change needed) =====
...
# ===== Enhanced Web Panel (web.py) - Updated for UI/Localization/Features =====
...
# ===== API Service (api.py) - Slight update for clarity =====
...
# ===== Telegram Bot (bot.py) - Updated for language/fields =====
...
# ===== Daily Cleanup Script (cleanup.py) - NEW SCRIPT =====
...
# ===== systemd Services (Updated with Cleanup) =====
...
# Cleanup Service (Daily) - NEW SERVICE
...
echo -e "  ✓ Localization (English/Myanmar)"
echo -e "  ✓ Daily Auto-Suspend of Expired Users"
echo -e "  ✓ Max Connections Display/Control Field"
echo -e "$LINE"
